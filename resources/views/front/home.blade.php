            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="{{route ('bola') }}">dumbell</a></li>
                            <li><a href="{{route ('basket') }}"> Tali Skipping</a></li>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{asset('assets/img/hero/olahraga1.png')}}">
                        <div class="hero__text">
                            <span>ALAT OLAHRAGA</span>
                            <h2>Alat GYM <br />100% Terjamin<h2>
                            <p>Pengiriman Gratis Tersedia</p>
            ...
            <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{ $data->image() }}">
                           
                        </div>
                        <div class="featured__item__text">
                            <h6><a href="./detail">{{ $data->nama_barang }}</a></h6>
