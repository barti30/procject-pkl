            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="{{route ('bola') }}">Sepak Bola</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__subtotal">Harga<span>$150.000</span></div>
                                <div class="checkout__order__total">jumlah barang <span>$2</span></div>
                                <div class="checkout__order__subtotal">Total <span>$300.000</span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
